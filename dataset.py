...
class FlickrLogosDataset(Dataset):
    def __init__(self, img_dir, file_names, class_names, box_coords, transforms=None):
        ...
        self.class_to_idx = {class_name: idx for idx, class_name in enumerate(set(class_names))}
    ...
    def __getitem__(self, idx):
        ...
        targets = {}
        targets['labels'] = torch.tensor([self.class_to_idx[self.class_names[idx]]], dtype=torch.int64)
